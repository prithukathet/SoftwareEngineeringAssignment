...
public class FermatTheoremNearMisses {
    // Initialization and declaration of static Scanner class to get input from the
    // user
    ...
    public static void main(String[] args) {
        int n = 0;
        while (true) {
            // Prompting the user to enter a value of exponent (n) greater than 2 and less
            // than 12
        ...
        int k = 0;
        while (true) {
            // Prompting the user to enter the upper limit (k), where k should be greater
            // than or equal to 10
        ...
        // Calling the static method calculateNearMiss and passing the two arguments, n
        // and k
    ...
    public static void calculateNearMiss(int n, int k) {
        // Initializing minRelativeMiss to the maximum possible double value to track
        // the smallest relative miss
        double minRelativeMiss = Double.MAX_VALUE;
        // Variables to track the best values of x, y, z and their corresponding misses
        int bestX = 0, bestY = 0, bestZ = 0;
        double bestMiss = 0;

        System.out.println("Running Tests for n = " + n + ", K = " + k);
        System.out.println("----------------------------------------------------");

        // Loop through all combinations of x and y, starting from 10 up to the upper
        // limit k
        for (int x = 10; x <= k; x++) {
            for (int y = 10; y <= k; y++) {
                ...
                int z = (int) Math.floor(Math.pow(xnPlusYn, 1.0 / n)); // Start z at the approximate nth root of (x^n +
                                                                       // y^n)
                ...
                // Update the smallest relative miss and corresponding values if a new smaller
                // miss is found
        ...
        // After all combinations, check if any near misses were found (bestX, bestY,
        ...
        // print separator to indicate end of results
        System.out.println("-----------------------------------------");
        System.out.println("End of test for n = " + n + ", K = " + k);
        System.out.println();

        // Prompt the user to press Enter to exit, pausing the execution to allow them
        // to view the results
